...
suspend fun AppDatabase.ensureSeeded() {
    ...
    comments().insert(
        CommentEntity(
            ...
            text = "Набережна нова, а вода та сама. Хто їде з села в місто - теж шукає, де стати ногою.",
    ...
    comments().insert(
        CommentEntity(
            ...
            text = "Черга за ліками - не ліс, але біль чути й тут. Аптека світить, як чужа зоря.",
    ...
    comments().insert(
        CommentEntity(
            ...
            text = "У метро тісно, як у долі. Але тиша між станціями - чесна.",
